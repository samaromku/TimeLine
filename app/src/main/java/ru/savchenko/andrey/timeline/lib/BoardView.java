...
package ru.savchenko.andrey.timeline.lib;
...
public class BoardView extends HorizontalScrollView implements AutoScroller.AutoScrollListener {
    ...
    public void setListDragDisable(){
        if(mLists.size()>0) {
            mLists.get(1).setDragEnabled(false);
        }
    }
    ...
    public DragItemRecyclerView addColumnList(final DragItemAdapter adapter, boolean hasFixedItemSize) {
